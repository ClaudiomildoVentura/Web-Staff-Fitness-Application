...
export default class PersonalShoppingScreen extends Component {
	...
	validarCampos = async e => {
		...
		console.log(id)
		console.log("ABC" + this.state.campos[id] + "   " + this.state.erros[id] + this.state.validos[id])
...
//		 console.log(this.state.compra.session)
//		 console.log(Object.keys(appp))
	} 
...
//				this.setState({purchaseinfo: content})
				let newState = {}
//				console.log(this.state.purchaseinfo)				
				...
				switch (content.method) {
					...
					case 'boleto':
						...
						if(this.state.paymentLink != ''){
							console.log('a compra foi feita com sucesso sujeito!')
